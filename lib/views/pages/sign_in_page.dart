...
class SignIn extends StatelessWidget {
  ...
  Widget _getSignInUi(SignInBloc bloc) {
    return Container(
                    ...
                    child: CustomButton(
                      ...
                      onPressed: () {
                        if (_emailController.text == "") {
                          bloc.add(SignInResponseEvent("Email must be filled"));
                        } else if (_passwordController.text == "") {
                          bloc.add(
                              SignInResponseEvent("Password must be filled"));
                        } else {
                          bloc.add(SignInRequestEvent(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<SignInBloc, SignInState>(builder: (context, state) {
        if (state is SignInResponseState) {
          return Stack(
            children: [
              _getSignInUi(bloc),
            ],
